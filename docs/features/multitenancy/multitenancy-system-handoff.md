...
- `D:/source/Aviendha/Aiel/src/Aiel.EntityFrameworkCore/Aiel/EntityFrameworkCore/TrDbContext.cs` — provisional EF base context; rename to `AielDbContext`.
- `D:/source/Aviendha/Aiel/src/Aiel.EntityFrameworkCore/Aiel/EntityFrameworkCore/ModelBuilderExtensions.cs` — existing global query-filter implementation.
- `D:/source/Aviendha/Aiel/tests/Aiel.EntityFrameworkCore.IntegrationTests/Aiel/EntityFrameworkCore/TrDbContextTests.cs` — current discriminator tests to extend.
