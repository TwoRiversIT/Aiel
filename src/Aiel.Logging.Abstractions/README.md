...
Meta package containing Roslyn source analyzers + code fixes that enforce the **Aiel structured-logging convention** at compile time — zero runtime overhead, IDE-integrated, `FixAll`-capable.  For more information, see the [Aiel.Logging](https://github.com/TwoRiversIT/Aiel/blob/main/src/Aiel.Logging/README.md) documentation.
