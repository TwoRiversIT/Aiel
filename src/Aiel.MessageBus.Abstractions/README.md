...
Transport-backed integration message contracts for Aiel-based applications. For more information, see the [Aiel.MessageBus](https://github.com/TwoRiversIT/Aiel/blob/main/src/Aiel.MessageBus/README.md) documentation.
